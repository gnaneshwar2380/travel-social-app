        ...
        <div className="flex w-full min-h-screen font-sans">
            ...
            <div className="hidden lg:flex w-1/2 items-center justify-center bg-gray-100 p-12">
                 <div className="relative w-full max-w-lg flex items-center justify-center">
                    {/* You can play with positioning and rotation to match the design perfectly */}
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="max-w-md w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <a href="#" className="block text-center text-sm text-teal-500 hover:underline mt-4">Forgot Password?</a>
                    </form>
